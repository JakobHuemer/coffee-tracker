...
const COFFEES = [
  ...
  { id: 'ristretto',       name: 'Ristretto',       caffeine: 60,  icon: 'coffee',    class: 'coffee' },
  ...
  { id: 'white_americano', name: 'White Americano', caffeine: 60,  icon: 'coffee',    class: 'coffee' },
  ...
  { id: 'melange',         name: 'Melange',         caffeine: 70,  icon: 'milk',      class: 'coffee' },
  ...
  { id: 'milk',            name: 'Milk',            caffeine: 0,   icon: 'milk',      class: 'milk' },
